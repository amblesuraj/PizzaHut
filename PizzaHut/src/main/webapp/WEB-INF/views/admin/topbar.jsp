    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <a class="btn-circle btn-lg btn btn-primary"><i class="fas fa-sign-out-alt text-white"></i></a>
        	Do You really want to logout ?
        	
        	</div>
        <div class="modal-footer">
          <button class="btn btn-primary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-danger" href="${pageContext.request.contextPath}/dashboard/logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
