 <div class="container shadow">
                <div class="row text-justify">
                    ...
                    <div class="col-lg-12 text-center mt-4 mb-4">
                        <h4 class="font-weight-bold">Terms and Conditions for PizzaHut</h4>
                    </div>
  
               
       
               
<h4><i class="fa fa-angle-double-right"></i> &nbsp;Introduction</h4>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Intellectual Property Rights</h5>
<p>	
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Restrictions</h5>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Your Content</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;No warranties</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Limitation of liability</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Indemnification</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Severability</h5>
<p>
If any provision of these Terms is found to be invalid under any applicable law, such provisions shall be deleted without affecting the remaining provisions herein.
</p>

<h5><i class="fa fa-angle-double-right"></i> &nbsp;Variation of Terms</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Assignment</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Entire Agreement</h5>
<p>
...
<h5><i class="fa fa-angle-double-right"></i> &nbsp;Governing Law & Jurisdiction</h5>
<p>
